				...
				<ContentBlock animate r>
					...
					<div className="contentblock-image">
						<LazyImage
							className="no-touch"
							draggable={false}
							alt="A illustration visualizing the communities range of different helpdesk categories."
							src={
								theme === "dark"
									? require("../assets/illustrations/helpdesk-dark.svg")
											.default
									: require("../assets/illustrations/helpdesk-light.svg")
											.default
							}
						/>
					</div>
				...
				<ContentBlock animate>
					...
					<div className="contentblock-image">
						<LazyImage
							...
							draggable={false}
							alt={
								"Illustration of a chat bubble displaying the topic of this month's campfire chat, with a campfire symbol in front. The chat bubble indicates that 209 members have responded."
							}
							src={
								theme === "dark"
				...
				<ContentBlock animate r>
					...
					<div className="contentblock-image">
						<LazyImage
							className="no-touch"
							draggable={false}
							alt="Illustration of a thread where you can showcase your work and get valuable feedback from other community members and experts in the field."
							src={
								theme === "dark"
									? require("../assets/illustrations/showcase-dark.svg")
											.default
									: require("../assets/illustrations/showcase-light.svg")
											.default
							}
						/>
					</div>
